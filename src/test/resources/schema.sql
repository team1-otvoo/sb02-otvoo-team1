...
DROP TABLE IF EXISTS attribute_candidates CASCADE;
...
DROP TABLE IF EXISTS weather_temperatures CASCADE;
...
DROP TABLE IF EXISTS weather_precipitations CASCADE;
...
DROP TABLE IF EXISTS weather_humidities CASCADE;
...
DROP TABLE IF EXISTS weather_wind_speeds CASCADE;
...
DROP TABLE IF EXISTS clothes_selected_values CASCADE;
...
DROP TABLE IF EXISTS clothes_ai_attributes CASCADE;
...
-- clothes_images 테이블
DROP TABLE IF EXISTS clothes_images CASCADE;
...
CREATE TABLE recommendations (
                                 ...
                                 weather_id UUID      NOT NULL UNIQUE,
                                 created_at TIMESTAMP NOT NULL DEFAULT NOW(),
...
-- async_task_failures 테이블
DROP TABLE IF EXISTS async_task_failures CASCADE;
