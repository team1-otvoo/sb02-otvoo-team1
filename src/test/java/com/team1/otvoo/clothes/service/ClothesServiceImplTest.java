...
class ClothesServiceImplTest {
  ...
  void createClothes_Success() {
    ...
    given(clothesMapper.toDto(saved, null)).willReturn(expected);

    // when
    ClothesDto result = clothesServiceImpl.create(request, null);
    ...
    then(clothesMapper).should().toDto(saved, null);
  }
